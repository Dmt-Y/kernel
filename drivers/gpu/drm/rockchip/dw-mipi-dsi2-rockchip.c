...
static struct dw_mipi_dsi2 *to_dsi(struct drm_encoder *encoder)
{
...
{
	struct dw_mipi_dsi2 *dsi2 = to_dsi(encoder);
...
*/
	...
	drm_connector_set_orientation_from_panel(&dsi2->connector, dsi2->panel);
